...
static char fonts_1[]            = "Noto Sans CJK SC:pixelsize=18";
static char fonts_2[]            = "Twemoji:pixelsize=15";
...
ResourcePref resources[] = {
		{ "fonts_0",		STRING,	&fonts_0 },
		{ "fonts_1",		STRING,	&fonts_1 },
		{ "fonts_2",		STRING,	&fonts_2 },
